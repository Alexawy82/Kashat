...
# Configuration
JWT_SECRET_KEY = os.getenv("KASHAT_JWT_SECRET", "ledgerloop-dev-secret-change-in-production")
JWT_ALGORITHM = "HS256"
...
def is_registration_enabled() -> bool:
    ...
    return os.getenv("KASHAT_ALLOW_REGISTRATION", "false").lower() in ("true", "1", "yes")
